...
function HomeLeft() {
  return (
    <div className="section section-left">
      ...
      <div className="description-container">
        <p>
          Currently looking for new challenges to elevate my developer skills. I
          am eager to learn and to dig deeper in tech, as per now I`m 2,5 years
          in to my developer journey and my passion for code keeps growing every
          day.
          <Link to="projects">
